...
# Indexes
#
#  index_ahoy_visits_on_application_id                (application_id)
...
#
class Yawl::Visit < ApplicationRecord
  self.ignored_columns = %w[user_id]
  self.table_name = "ahoy_visits"

  has_many :events, class_name: "Yawl::Event"
  belongs_to :application, optional: true

  validates_presence_of :visit_token
  validates_uniqueness_of :visit_token
end
